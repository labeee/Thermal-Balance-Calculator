...
sala = {
    "ZONE": "SALA",
    "convection": {
        "SALA_PARIN_01S": "convection?none_intwalls",
        "SALA_PARIN_00E": "convection?none_intwalls",
        "SALA_PORTAIN_0_00E": "convection?none_intwalls",
        "SALA_PARIN_01D": "convection?none_intwalls",
        "SALA_PORTAIN_0_01D": "convection?none_intwalls",
        "SALA_PARIN_02D": "convection?none_intwalls",
        "SALA_PORTAIN_0_02D": "convection?none_intwalls",
        "SALA_PAREX_00I": 'convection?south_extwalls',
        "SALA_PAREX_01E": 'convection?west_extwalls',
        "SALA_PAREX_00S": 'convection?north_extwalls',
        "SALA_PORTAEX_0_00S": 'convection?north_extwalls',
        'SALA_JAN_0_01E:Surface Inside': 'convection?west_windows',
        'SALA_JAN_0_00I:Surface Inside': 'convection?south_windows',
        'SALA_JAN_0_00I:Surface Window': 'convection?south_frame',
        'SALA_JAN_0_01E:Surface Window': 'convection?west_frame',
        'SALA:Zone Total': 'convection?internal_gains',
        'SALA:AFN Zone Ventilation Sensible Heat Gain': 'convection?vn_window_gain',
        'SALA:AFN Zone Ventilation Sensible Heat Loss': 'convection?vn_window_loss',
        'SALA:AFN Zone Mixing Sensible Heat Gain': 'convection?vn_interzone_gain',
        'SALA:AFN Zone Mixing Sensible Heat Loss': 'convection?vn_interzone_loss',
        'SALA:Zone Air System Sensible Heating': 'convection?heating',
        'SALA:Zone Air System Sensible Cooling': 'convection?cooling'},
    "surface": {
...
dorm1 = {
    "ZONE": "DORM1",
    "convection": {
        "DORM1_PARIN_00E": 'convection?none_intwalls',
        "DORM1_PARIN_00S": 'convection?none_intwalls',
        "DORM1_PORTAIN_0_00E": 'convection?none_intwalls',
        "DORM1_PAREX_00I": 'convection?south_extwalls',
        "DORM1_PAREX_00D": 'convection?east_extwalls',
        "DORM1_PISO": 'convection?none_floor',
        'DORM1_COB': 'convection?none_roof',
        'DORM1_JAN_0_00I:Surface Inside': 'convection?south_windows',
        'DORM1_JAN_0_00I:Surface Window': 'convection?south_frame',
        'DORM1:Zone Total Internal': 'convection?internal_gains',
        'DORM1:AFN Zone Ventilation Sensible Heat Gain': 'convection?vn_window_gain',
        'DORM1:AFN Zone Ventilation Sensible Heat Loss': 'convection?vn_window_loss',
        'DORM1:AFN Zone Mixing Sensible Heat Gain': 'convection?vn_interzone_gain',
        'DORM1:AFN Zone Mixing Sensible Heat Loss': 'convection?vn_interzone_loss',
        'DORM1:Zone Air System Sensible Heating': 'convection?heating',
        'DORM1:Zone Air System Sensible Cooling': 'convection?cooling'},
    "surface": {
...
dorm2 = {
    "ZONE": "DORM2",
    "convection": {
        "DORM2_PARIN_00I": 'convection?none_intwalls',
        "DORM2_PARIN_01E": 'convection?none_intwalls',
        "DORM2_PORTAIN_0_01E": 'convection?none_intwalls',
        "DORM2_PAREX_00E": 'convection?west_extwalls',
        "DORM2_PAREX_00D": 'convection?east_extwalls',
        'DORM2_PAREX_00S': 'convection?north_extwalls',
        'DORM2_PISO': 'convection?none_floor',
        'DORM2_COB': 'convection?none_roof',
        'DORM2_JAN_0_00D:Surface Inside': 'convection?east_windows',
        'DORM2_JAN_0_00D:Surface Window': 'convection?east_frame',
        'DORM2:Zone Total Internal': 'convection?internal_gains',
        'DORM2:AFN Zone Ventilation Sensible Heat Gain': 'convection?vn_window_gain',
        'DORM2:AFN Zone Ventilation Sensible Heat Loss': 'convection?vn_window_loss',
        'DORM2:AFN Zone Mixing Sensible Heat Gain': 'convection?vn_interzone_gain',
        'DORM2:AFN Zone Mixing Sensible Heat Loss': 'convection?vn_interzone_loss',
