...
# setwd("D:/OneDrive/OneDrive - UFSC/Artigos/2023_Thesis/simulacoes/2023-06-13/convection/reference") #pc labeee
# setwd("C:/Users/Letícia/OneDrive - UFSC/Artigos/2023_Thesis/simulacoes/2023-06-13/convection/reference/") #pc leticia
# setwd("C:/Users/Letícia/OneDrive - UFSC/Artigos/2023_Thesis/simulacoes/2023-06-13/estrategias/rodada1/resultados/")
# setwd("D:/OneDrive/OneDrive - UFSC/Artigos/2023_Thesis/simulacoes/2023-06-13/convection/reference")
setwd("D:/OneDrive/OneDrive - UFSC/Artigos/2023_Thesis/simulacoes/2023-06-13/convection/reference")
  ...
  if(timestep == "annual"){
    ...
    for(i in c(1:length(trocas))){
      for(j in c(1:nrow(trocas[[i]]))){
        ...
        trocas[[i]]$sum[j] = sum(trocas[[i]]$value[which(trocas[[i]]$gains == k & trocas[[i]]$case == c & trocas[[i]]$time == t & trocas[[i]]$day == d & trocas[[i]]$month == m)])
        trocas[[i]]$per[j] = round(trocas[[i]]$value[j]/sum(trocas[[i]]$value[which(trocas[[i]]$gains == k & trocas[[i]]$case == c & trocas[[i]]$time == t & trocas[[i]]$day == d & trocas[[i]]$month == m)]),4)
      }
    }
  }
}
...
# setwd("D:/OneDrive/OneDrive - UFSC/Artigos/2023_Thesis/simulacoes/2023-06-13/convection/reference/graphs/") #pc labeee
# setwd("C:/Users/Letícia/OneDrive - UFSC/Artigos/2023_Thesis/simulacoes/2023-06-13/convection/reference/graphs")
# setwd("C:/Users/Letícia/OneDrive - UFSC/Artigos/2023_Thesis/simulacoes/2023-06-13/estrategias/rodada1/resultados/graph/")
setwd("D:/OneDrive/OneDrive - UFSC/Artigos/2023_Thesis/simulacoes/2023-06-13/convection/reference/graphs")
